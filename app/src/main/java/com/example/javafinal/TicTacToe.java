...
import com.example.javafinal.databinding.ActivityTicTacToeBinding;
...
public class TicTacToe extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            ...
            if (checkResults()) {
                ResultDialog resultDialog = new ResultDialog(TicTacToe.this, binding.playerTwoName.getText().toString()
                        + " is a Winner!", TicTacToe.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
            } else if (totalSelectedBoxes == 9) {
